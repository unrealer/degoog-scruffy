...
export default class KagiNewsEngine {
  ...
  settingsSchema = [
    ...
    { key: "limit", label: "Results per page", type: "number", default: 10, description: "Maximum news results requested per page (Kagi allows 1-1024)." },
  ...
  async executeSearch(query, page = 1, _timeFilter, context) {
    const data = await kagiSearch({ apiKey: this.apiKey, limit: this.limit, safeSearch: this.safeSearch, workflow: "news", name: this.name }, query, page, context);
