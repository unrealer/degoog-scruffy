...
export default class KagiVideosEngine {
  ...
  settingsSchema = [
    ...
    },
    {
      ...
      type: "number",
      default: 10,
      description: "Maximum video results requested per page (Kagi allows 1-1024).",
    },
    {
      key: "safeSearch",
      label: "Safe Search",
  ...
  async executeSearch(query, page = 1, _timeFilter, context) {
    const data = await kagiSearch(
      { apiKey: this.apiKey, limit: this.limit, safeSearch: this.safeSearch, workflow: "videos", name: this.name },
      query,
      page,
      context,
    );
